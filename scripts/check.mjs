...
assert(html.includes("./styles.css?v=20260617-simplified-content"));
assert(html.includes("./script.js?v=20260617-simplified-content"));
...
assert.equal(suggestions.fields.loop_type.required, undefined);
